...
<body>
  ...
  <div id="contentWrapper">
    <form id="loginForm" class="form" action="./login.php" method="post" autocomplete="off">
      <div id="logonBox">
        <div id="login" class="logonBoxCentered">
          <div id="usernameContainer">
            <div class="label-container"><label for="username">Username</label></div>
            <input class="inputText" type="text" name="uid" id="userid" tabindex="1" autocomplete="off" />
          </div>
          <div id="passwordContainer">
            <div class="label-container"><label for="password">Password</label></div>
            <input class="inputText" type="password" name="pwd" id="password"  tabindex="2" autocomplete="off" />
          </div>
        </div>
      </div>
      <?php
