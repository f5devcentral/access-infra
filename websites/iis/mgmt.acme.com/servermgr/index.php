...
<body>
  <div class='header'>
    <div class='header-content'>
      <div class='header-title'>ACME Server Manager</div>
             ...
             $vs_name=$vs['items'][$i]['name'];
               ...
               if (!empty($vs_pool)) { 
                 ...
                 for ($m=0; $m < count($vs_pool_details["membersReference"]["items"]); $m++) {
                   ...
                   echo "<tr><td width='60%'><a title=\"".$vs_member_state.":".$vs_member_session."\" class='tooltip'><img src='./img/".$member_icon."_sm.png'></a></td><td>".$vs_member."</td>";
