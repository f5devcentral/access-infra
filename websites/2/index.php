<?php
  ...
  $green_shadow="-moz-box-shadow: inset 0 30px 30px -30px rgba(34, 139, 34, 0.5), 0 20px 20px -20px rgba(0, 0, 0, 0.5); -webkit-box-shadow: inset 0 30px 30px -30px rgba(34, 139, 34, 0.5), 0 20px 20px -20px rgba(0, 0, 0, 0.5); box-shadow: inset 0 30px 30px -30px rgba(34, 139, 34, 0.5), 0 20px 20px -20px rgba(0, 0, 0, 0.5);";
  $blue_shadow="-moz-box-shadow: inset 0 30px 30px -30px rgba(70, 130, 180, 0.5), 0 20px 20px -20px rgba(0, 0, 0, 0.5); -webkit-box-shadow: inset 0 30px 30px -30px rgba(70, 130, 180, 0.5), 0 20px 20px -20px rgba(0, 0, 0, 0.5); box-shadow: inset 0 30px 30px -30px rgba(70, 130, 180, 0.5), 0 20px 20px -20px rgba(0, 0, 0, 0.5);";
  $white_shadow="-moz-box-shadow: inset 0 30px 30px -30px rgba(70, 130, 180, 0.5), 0 20px 20px -20px rgba(0, 0, 0, 0.5); -webkit-box-shadow: inset 0 30px 30px -30px rgba(70, 130, 180, 0.5), 0 20px 20px -20px rgba(0, 0, 0, 0.5); box-shadow: inset 0 30px 30px -30px rgba(70, 130, 180, 0.5), 0 20px 20px -20px rgba(0, 0, 0, 0.5);";
  $red_bckgrnd="background-color: #b22222;";
  $green_bckgrnd="background-color: #228b22;";
  $blue_bckgrnd="background-color: #4682b4;";
